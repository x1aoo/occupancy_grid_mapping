...
path = zeros(frame,7);
    ...
    corners_y = scale*[b/2, -b/2, -b/2, b/2, b/2, -b/2, -b/2, b/2]; % left/right
    ...
    corners = corners(1:3,:);
    patch(corners(1,1:4),corners(2,1:4),corners(3,1:4),'k.');
    patch(corners(1,5:8),corners(2,5:8),corners(3,5:8),'k.');
%     % Top face
